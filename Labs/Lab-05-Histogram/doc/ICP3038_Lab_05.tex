...
\begin{itemize}
    ...
    \begin{itemize}
    	...
    	\item The second bin starts at 1.24054 and finishes at $1.24054 + 2.07768 = 3.31822$.
    	\item The third bin starts at 3.31822 and finishes at $3.31822 + 2.07768 = 5.3959$.
    \end{itemize}
    \item If there are $N$ bins, their size is $6.23304 / N$. 
    \begin{itemize}
    	\item The first bin starts at -0.83714 and finishes at $-0.83714 + 1 \times 6.23304 / N$.
    	\item The second bin starts at $-0.83714 + 1 \times 6.23304 / N$ and finishes at $-0.83714 + 2 \times 6.23304 / N$.
	\item The last bin starts at $-0.83714 + (N - 1) \times 6.23304 / N$ and finishes at $-0.83714 + N \times 6.23304 / N$.
	\item To generalise: The $i$-th bin starts at $-0.83714 + (i - 1) \times 6.23304 / N$ and finishes at $-0.83714 + i \times 6.23304 / N$.
    \end{itemize}
...
\begin{figure}[!h]
\centering
\subfigure[\label{fig:matlabEPS}EPS file.]{\includegraphics[width=0.4\linewidth]{../data/histogram_matlab.eps}}\hfill
\subfigure[\label{fig:matlabPNG}PNG file.]{\includegraphics[width=0.4\linewidth]{../data/histogram_matlab.png}}
