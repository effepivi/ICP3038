...
//-----------------------------------------------------------------
inline void displayArray(double* apArray, size_t aNumberOfElements)
//-----------------------------------------------------------------
{
    for (unsigned int i(0); i < aNumberOfElements; ++i)
    {
        cout << i << "\t" << apArray[i] << std::endl;
    }
}


//------------------------------------------------------------------------
inline void reverseDisplayArray(double* apArray, size_t aNumberOfElements)
//------------------------------------------------------------------------
{
    for (unsigned int i(aNumberOfElements); i > 0; --i)
    {
        cout << i << "\t" << apArray[i - 1] << "\t";
    }
}
...
//--------
{
    ...
    displayArray(p_random_number_set, 50);
    cout << endl << endl;

    // Display every element in reverse order
    reverseDisplayArray(p_random_number_set, 50);
    cout << endl << endl;
    ...
    // Copy 40 (50 - 10) elements in p_temp
